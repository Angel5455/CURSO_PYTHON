...
def barra_menu(root):
    ...
    #crear menus
    menu_inicio = tk.Menu(barra_menu, tearoff = 0) #tearoff es para borrar la linea que sale por defaul
...
class Frame(tk.Frame):
    ...
    def tabla_peliculas(self):
        ...
        #self.tabla.insert('',0, text="1", value=('Los Vengadores', '2.35', 'Accion, Comedia'))
